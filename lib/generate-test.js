...
test('should expand Date as ISO string', (t) => {
  const compiled = ['http://example.com/', ['?', { param: 'updatedAfter' }]]
  const params = { updatedAfter: new Date('2017-05-12T18:43:00.000Z') }
  const expected = 'http://example.com/?updatedAfter=2017-05-12T18%3A43%3A00.000Z'
